...
public class ParserKarpRabin {
    ...
    public ParserKarpRabin(ParametrageParser parametrage, SequenceADN sequenceADN) {
     ...
     *
     * @param word  la chaine à calculer
     * @return la valeur de hachage de la chaine word
     */
    private int getHachageValue(String word){
        int result = 0;
     ...
     *
     * @param aChar le char à chercher
     * @return la valeur du char dans notre alphabet
     */
    private int IdAlphabet(char aChar){
        switch(aChar){
            case 'A' :
                return 1;
            case 'C' :
